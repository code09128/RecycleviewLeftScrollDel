...
//    private TextView mTextView_Set;//设置按钮
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!once) {
            mTextView_Delete = (TextView) findViewById(com.drs24.recycleviewleftscrolldel.R.id.tv_delete);
//            mTextView_Set = (TextView) findViewById(com.drs24.recycleviewleftscrolldel.R.id.tv_set);
            once = true;
        }
    }
